íhimport { useQuery } from "@tanstack/react-query";
        ...
        <div className="space-y-8">
            ...
            >
                ...
                <motion.div variants={item}>
                    <div className="kaleido-card p-6 relative overflow-hidden group">
                        ...
                        <div className="text-3xl font-bold tracking-tight text-white mb-1">
                            {isLoading ? <Skeleton className="h-8 w-16 bg-white/10" /> : stats.overrides}
                        </div>
                ...
                <motion.div variants={item}>
                    <div className="kaleido-card p-6 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Copy className="w-24 h-24 text-purple-400" />
                        </div>
                        <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="text-3xl font-bold tracking-tight text-white mb-1">
                            {isLoading ? <Skeleton className="h-8 w-16 bg-white/10" /> : stats.aliases}
                        </div>
                ...
                <motion.div variants={item}>
                    <div className="kaleido-card p-6 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <History className="w-24 h-24 text-pink-400" />
                        </div>
                        <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="text-3xl font-bold tracking-tight text-white mb-1">
                            {isLoading ? <Skeleton className="h-8 w-16 bg-white/10" /> : stats.auditCount}
                        </div>
                ...
                <motion.div variants={item}>
                    <div className="kaleido-card p-6 relative overflow-hidden group bg-gradient-to-br from-[#151929] to-primary/5">
                        <div className="flex items-center gap-4 mb-4">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                >
                    <div className="flex items-center justify-between mb-8">
                        <h3 className="text-lg font-semibold text-white">Vulnerability Trend (Last 100 Blocks)</h3>
                        <div className="flex gap-2">
                            <div className="px-3 py-1 rounded-full bg-white/5 text-xs text-muted-foreground hover:bg-white/10 cursor-pointer transition-colors">Day</div>
                            <div className="px-3 py-1 rounded-full bg-primary/20 text-primary text-xs font-medium cursor-pointer">Week</div>
                            <div className="px-3 py-1 rounded-full bg-white/5 text-xs text-muted-foreground hover:bg-white/10 cursor-pointer transition-colors">Month</div>
                        </div>
                    </div>

                    {/* Visual Bar Chart Placeholder */}
                    <div className="flex-1 flex items-end justify-between gap-2 px-4 pb-4 opacity-80">
                        {Array.from({ length: 24 }).map((_, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`w-full rounded-t-sm ${isActive ? 'bg-primary shadow-[0_0_15px_rgba(34,211,238,0.5)]' : 'bg-white/5 hover:bg-white/10'}`}
                                />
                            )
                        })}
                    </div>
                                ...
                                stats.recentActivity.map((entry: any, i: number) => (
                                    <div key={i} className="group flex items-center justify-between p-3 rounded-lg hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-white/5">
                                        <div className="flex items-center gap-3 overflow-hidden">
                                            <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-muted-foreground group-hover:text-primary group-hover:bg-primary/20 transition-colors">
                                        ...
                                        <div className="text-xs font-mono text-muted-foreground/60 whitespace-nowrap bg-black/20 px-2 py-1 rounded">
...
ê *cascade08êì*cascade08ìî *cascade08îñ*cascade08ñ¶ *cascade08¶≠*cascade08≠Æ *cascade08ÆØ*cascade08Ø∞ *cascade08∞≤*cascade08≤µ *cascade08µ∂*cascade08∂∫ *cascade08∫∆*cascade08∆Ô *cascade08Ô™*cascade08™¨ *cascade08¨À[ *cascade08À[œ[œ[Òg *cascade08Ògíh *cascade082Gfile:///c:/SCOUTNEW/scout_db/frontend/src/pages/Dashboard/Dashboard.tsx