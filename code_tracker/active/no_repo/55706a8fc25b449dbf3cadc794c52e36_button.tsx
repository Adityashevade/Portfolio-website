...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transition-all duration-300 ease-out active:scale-95 hover:shadow-lg hover:-translate-y-0.5",
    {
        variants: {
            variant: {
...
×*cascade082Bfile:///C:/SCOUTNEW/scout_db/frontend/src/components/ui/button.tsx